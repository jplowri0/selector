...
# Corrected the index for selected categories
selected_categories = [df.columns[2 + choice] for choice in range(1, len(df.columns[3:]) + 1) if (choice - 1) in [category_choice - 1 for category_choice in selected_categories]]
